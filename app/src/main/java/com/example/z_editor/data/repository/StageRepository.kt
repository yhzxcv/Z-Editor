...
object StageRepository {
    private val STAGE_DATABASE = listOf(
        ...
        StageItem("WestStage", "狂野西部", "Stage_West.webp", StageType.Main),
        StageItem("KongfuStage", "功夫世界", "Stage_Kongfu.webp", StageType.Main),
        StageItem("FutureStage", "遥远未来", "Stage_Future.webp", StageType.Main),
        StageItem("DarkStage", "黑暗时代", "Stage_Dark.webp", StageType.Main),
        StageItem("BeachStage", "巨浪沙滩", "Stage_Beach.webp", StageType.Main),
        StageItem("IceageStage", "冰河世纪", "Stage_Iceage.webp", StageType.Main),
        StageItem("LostCityStage", "失落之城", "Stage_LostCity.webp", StageType.Main),
        StageItem("SkycityStage", "天空之城", "Stage_Skycity.webp", StageType.Main),
        StageItem("EightiesStage", "摇滚年代", "Stage_Eighties.webp", StageType.Main),
        StageItem("DinoStage", "恐龙危机", "Stage_Dino.webp", StageType.Main),
        StageItem("ModernStage", "现代世界", "Stage_Modern.webp", StageType.Main),
        StageItem("SteamStage", "蒸汽时代", "Stage_Steam.webp", StageType.Main),
        StageItem("RenaiStage", "复兴时代", "Stage_Renai.webp", StageType.Main),
        StageItem("HeianStage", "平安时代", "Stage_Heian.webp", StageType.Main),
        ...
        StageItem("MoonStage", "月球基地", "Stage_Moon.webp", StageType.Main),
        ...
        StageItem("TeamBossStage", "罗马世界", null, StageType.Extra),
        ...
        StageItem("JourneyToTheWestStage", "西游秘境", null, StageType.Extra),
        StageItem("DaveCupStage", "戴夫杯", null, StageType.Extra),
        StageItem("SouDaCheStage", "远征地图", null, StageType.Extra),
